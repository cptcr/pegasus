...
router.patch('/:guildId/settings', async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (updates.notifications) {
      ...
      if (notif.welcomeEmbed !== undefined) settingsUpdates.welcomeEmbedEnabled = notif.welcomeEmbed;
      ...
      if (notif.goodbyeEmbed !== undefined) settingsUpdates.goodbyeEmbedEnabled = notif.goodbyeEmbed;
    }
